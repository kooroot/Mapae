...
![Tests](https://img.shields.io/badge/tests-521%20TS%20%2B%2014%20Foundry-16A34A)
...
| 상시 게이트 | 문서·로깅·의존성 권고·테스트 수 상시 게이트, TypeScript 521 + Foundry 14, 두 체인 타깃 negative path 23/23, GIWA fork 온보딩 15/15 | 로컬 + GIWA 읽기 전용 검증 |
...
- 회귀 검증: **521 TypeScript tests (shared/delegation/scripts 425 + MCP 3 + 웹 93)
