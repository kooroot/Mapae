...
| 상시 게이트 | 문서·로깅·의존성 권고·테스트 수 상시 게이트, TypeScript 443 + Foundry 14, 두 체인 타깃 negative path 23/23 | 로컬 + GIWA 읽기 전용 검증 |
...
- 회귀 검증: **443 TypeScript tests (shared/delegation/scripts 310 + MCP 3 + 콘솔 94 + 웹 36)
