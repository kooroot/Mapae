...
| 상시 게이트 | 문서·로깅·의존성 권고·테스트 수 상시 게이트, TypeScript 574 + Foundry 14, 두 체인 타깃 negative path 23/23, GIWA fork 온보딩 15/15 | 로컬 + GIWA 읽기 전용 검증 |
...
- 회귀 검증: **574 TypeScript tests (shared/delegation/scripts 412 + MCP 3 + 콘솔 94 + 웹 65)
