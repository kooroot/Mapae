...
| 상시 게이트 | 문서·로깅·의존성 권고·테스트 수 상시 게이트, TypeScript 457 + Foundry 14, 두 체인 타깃 negative path 23/23 | 로컬 + GIWA 읽기 전용 검증 |

- MockUSDC: [`0xcfeb…e92`](https://sepolia-explorer.giwa.io/address/0xcfeb694719A09caeb80798e2011298F29CDa4e92)
- 직접 정산: [`0xc9ab…b7a9`](https://sepolia-explorer.giwa.io/tx/0xc9ab58de064e88776cf2681851849cb4d79ad5c457d2675c60cbdd6ffaa3b7a9)
...
- **에이전트 자율 정산**, MCP 1회 호출, 사람 개입 0:
  ...
  — block 32434935, payer −1.00 mUSDC, vendor +1.00 mUSDC, **payer 가스 지출 0**.
...
- 회귀 검증: **457 TypeScript tests (shared/delegation/scripts 324 + MCP 3 + 콘솔 94 + 웹 36)
