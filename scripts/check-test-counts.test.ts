...
const README_EN =
    ...
    "- Regression suite: **353 TypeScript tests (256 shared/delegation/scripts + 3 MCP + 94 console)\n" +
    "  + 14 Foundry tests**, plus a chain-parameterised negative-path suite\n";

const README_KO =
    "![Tests](https://img.shields.io/badge/tests-353%20TS%20%2B%2014%20Foundry-16A34A)\n" +
    "- 회귀 검증: **353 TypeScript tests (shared/delegation/scripts 256 + MCP 3 + 콘솔 94)\n" +
