...
| Standing gates | Documentation, logging, advisory and test-count gates; 468 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets | Local + read-only GIWA verification |
...
- Regression suite: **468 TypeScript tests (335 shared/delegation/scripts + 3 MCP + 94 console + 36 web)
