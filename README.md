...
![Tests](https://img.shields.io/badge/tests-443%20TS%20%2B%2014%20Foundry-16A34A)
...
| Standing gates | Documentation, logging, advisory and test-count gates; 443 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets | Local + read-only GIWA verification |
...
- Regression suite: **443 TypeScript tests (310 shared/delegation/scripts + 3 MCP + 94 console + 36 web)
