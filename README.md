...
| Standing gates | Documentation, logging, advisory and test-count gates; 512 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets; 15/15 onboarding cases on a GIWA fork | Local + read-only GIWA verification |
...
- Regression suite: **512 TypeScript tests (425 shared/delegation/scripts + 3 MCP + 84 web)
