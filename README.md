...
![Tests](https://img.shields.io/badge/tests-568%20TS%20%2B%2014%20Foundry-16A34A)
...
| Standing gates | Documentation, logging, advisory and test-count gates; 568 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets; 15/15 onboarding cases on a GIWA fork | Local + read-only GIWA verification |
...
- Regression suite: **568 TypeScript tests (406 shared/delegation/scripts + 3 MCP + 94 console + 65 web)
