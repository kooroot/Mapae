...
| Standing gates | Documentation, logging, advisory and test-count gates; 580 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets; 15/15 onboarding cases on a GIWA fork | Local + read-only GIWA verification |
...
- Regression suite: **580 TypeScript tests (418 shared/delegation/scripts + 3 MCP + 94 console + 65 web)
