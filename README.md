...
![Tests](https://img.shields.io/badge/tests-438%20TS%20%2B%2014%20Foundry-16A34A)
...
| Standing gates | Documentation, logging, advisory and test-count gates; 438 TypeScript + 14 Foundry tests; 23/23 negative paths on both chain targets | Local + read-only GIWA verification |
...
- Regression suite: **438 TypeScript tests (305 shared/delegation/scripts + 3 MCP + 94 console + 36 web)
